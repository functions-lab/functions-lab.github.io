...
<div class="row">
    <div class="col-sm-6">
        {% include figure.liquid loading="eager" path="assets/img/gallery/ece655_fall2025.jpg" title="ECE 655 Fall 2025" class="img-fluid rounded z-depth-1" zoomable=true %}
        <p class="caption">Final project presetation session for ECE/CompSci 655: Full-Stack IoT Systems (Dec. 2025)</p>
    </div>
    <div class="col-sm-6">
